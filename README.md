...
- **Flag**: optional path segment injected before query params — `/f01/`, `/m01/`, `/welcome/`, `/chm01/`, `/chf01/`, `/hopif01/`, `/milicaf01/`, `/milicam01/`, `/tchf01/`, `/tchm01/`, `/wallpif01/` — selected via a dropdown (one at a time)
...
4. Optionally select a **Flag** from the dropdown (`/f01/`, `/m01/`, `/welcome/`, `/chm01/`, `/chf01/`, `/hopif01/`, `/milicaf01/`, `/milicam01/`, `/tchf01/`, `/tchm01/`, `/wallpif01/`)
